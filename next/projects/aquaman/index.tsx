	...
	description: <>
		...
		<ImageSlider images={[
			{
				...
				caption: 'Shot of the custom Aquaman rig supplied to us by Roblox.'
			},
			{
				src: aquamanSwimming,
				caption: '"How do robots work underwater?" you might be wondering. I was too afraid to ask.'
			},
		]} />
		...
		<ImageSlider images={[
			...
			},
			{
				...
				caption: 'A glowing trench that leads players to their first enemy encounter.'
			},
			{
				src: trialChestPicking,
				caption: 'Players pick one of four chests in front of an imposing temple entrance to proceed.'
			},
			{
				src: trialGates,
				caption: 'Players fight robots in this room to pass the gate.'
			},
			{
				src: trialMainEncounter,
				caption: 'The main encounter, where players fight several types of robots.'
			},
		]} />
		...
		<ImageSlider images={[
			{
				src: trialLeverRoom,
				caption: 'The bottom half of a spacious room containing a lever.'
			},
			{
				src: trialLever,
				caption: 'Breaking rocks above the lever frees it from its cage, allowing the player to progress.'
			},
			{
				src: trialHallway,
			...
			},
			{
				...
				caption: 'The last room containing enemies before the boss.'
			},
			{
				src: trialBoss,
				caption: 'The final room where players faced off against giant robots in a boss battle'
			},
		]} />
		...
		<ImageSlider images={[
			{
				src: hubSpawn,
				caption: 'The enclosed room where player\'s spawn, which acts as a small tutorial'
			},
			{
				src: hubTrench,
				caption: 'Establishing shot of the trench that the player emerges out into after spawning.'
			},
			{
				src: hubCastle,
				caption: 'The imposing castle that looms over the spawn area.'
			},
			{
				src: hubArenaEntrance,
				caption: 'The entrance to the arena where players battle for exclusive items.'
			},
			{
				src: hubPathway,
				caption: 'A pathway just off the spawn area, leading the player along to the second trial.'
			},
			{
				src: hubTrialEntrance,
				caption: 'Entrance to the second trial, surrounded by ruins.'
			},
		]} />
		...
		<ImageSlider images={[
			{
				...
				caption: 'An establishing shot of the colluseum that players fought in.'
			},
			{
				src: arenaThrone,
				caption: 'Aerial shot that showcases the covered throne.'
			},
			{
				src: arenaDistance,
				caption: 'A look off into the arches and structures in the distance.'
			},
			{
				src: arenaRuins,
				caption: 'A shot of one of the spawn areas that players rush out from.'
			},
		]} />
		...
		<figure>
			<Image src={glowyChest} alt='A glowing treasure chest in a small, mossy alcove.' />
