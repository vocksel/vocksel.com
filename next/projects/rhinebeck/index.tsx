...
const project: Project = {
	...
	description: <>
		...
		<Image src={bedroom} alt='Overview of the master bedroom, showing off the space sheets on the bed and the computer desk' />
		...
		<Image src={outside} alt='Outside view of the streets and other buildings in front of the apartment' />
	</>
}
