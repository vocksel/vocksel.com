    ...
    return (
      <Section>
        <Content>
          ...
          <p>Feel free to <Link to="/contact" className={links.contact}>contact me <i className="fa fa-paper-plane-o" /></Link> with anything on your mind, I'd love to talk and get to know you.</p>
        </Content>
      </Section>
    );
  }
