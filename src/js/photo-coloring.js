 ...
 *
 * You need to apply the .js-color-scroll and .coloring--grayscale classes to
 * the image that you want to use. The first class is the hook we use, and the
 * second is to ensure images are grayscale by default.
 *
 * It can be setup so that .coloring--grayscale is applied when the script runs,
 * but then the images are briefly in color as the page loads.
 *
 ...
 * Example:
    ...
    <img class="js-color-scroll  coloring--grayscale" src="/img/sample.pmg">
...
function toggleColor(element) {
  element.classList.toggle('coloring--grayscale');
}
