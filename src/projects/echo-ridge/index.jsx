...
export default {
	...
	description: <>
		...
		<ImageSlider images={[
			{ src: require('./images/geos-house-exterior.jpg').default, caption: 'test' },
			{ src: require('./images/geos-living-room.jpg').default, caption: 'test' },
			{ src: require('./images/geos-room.jpg').default, caption: 'test' },
			{ src: require('./images/sky-wave-teleport.jpg').default, caption: 'test' },
			{ src: require('./images/sky-wave.jpg').default, caption: 'test' },
		]} />
