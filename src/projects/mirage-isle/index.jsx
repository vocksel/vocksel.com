...
export default {
	...
	description: (
		<div>
			<p>Amidst the sea in a location seldom traveled rests <Keyword>Mirage Isle</Keyword>, a small landmass sparsely covered with grass and trees. What appears to be a bastion of hope for weary travelers soon reveals itself as not much more than a desert at sea. With no food or drinkable water, sailors have described it as a mirage&mdash;hastily taking away what hope it initially inspired.</p>

			<img src={boat} alt="" />

			<p>A small boat rests atop the water, anchored to the dock. A tent and campfire sit just above. Someone has been here, but given the lack of sustainability, the chances they are still amongst the living is slim.</p>
